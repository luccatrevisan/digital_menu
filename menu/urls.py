...
from menu.views import index, CategoryViewSet, MenuItemViewSet, StockViewSet, MenuItemWithStockViewSet, MenuItemByCategoryViewSet, ComplementViewSet, ComplementGroupViewSet, ComplementByGroupViewSet
